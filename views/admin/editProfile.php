                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <?= $form->field($model, 'username')
                                  ->textInput(['autofocus' => true,'class' => 'form-control', 'id' => 'username','value' => $model->username]) ?>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              <?= $form->field($model, 'mobile_number')
                                  ->textInput(['class' => 'form-control', 'id' => 'mobile_number','value' => $model->mobile_number]) ?>
...
<!--                              <input type="email" class="form-control" name="email" id="email" placeholder="you@email.com" title="enter your email.">-->
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              <?= $form->field($model, 'location')->textInput(['class' => 'form-control', 'id' => 'location','value' => $model->location]) ?>
